...
for bname in ["A", "B", "C"]:
    ...
    fig.suptitle(
        f"GRB 260226A  Box {bname} \u2014 Event Scatter\n"
        f"T\u2080 = {burst_utc.iso}   MET = {burst_met:.0f}   "
    ...
    outfile = f"scatter_260226a_box{bname}_large.png"
