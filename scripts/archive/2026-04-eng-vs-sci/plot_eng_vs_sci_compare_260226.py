#!/usr/bin/env python3
"""Compare multiplicative vs additive dead time correction for GRB 260226A."""
import numpy as np
...
TRIGGER_MET = 446726301.0  # peak of burst
MET_CORRECTION = 4.0
...
fig.suptitle("GRB 260226A: Multiplicative vs Additive dead time correction", fontsize=14, y=0.998)
plt.savefig("plots/eng_vs_sci_compare_260226.png", dpi=150, bbox_inches="tight")
print("\nSaved: plots/eng_vs_sci_compare_260226.png")
plt.close()
