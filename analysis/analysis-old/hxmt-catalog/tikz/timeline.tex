...
\begin{tikzpicture}
    ...
    \path[draw=black, ultra thick, stealth-] (timeline_right) -- node[below] {Timeline} (background_right);
    ...
    \path[draw=C3, ultra thick] (exclude_left) -- node[above, anchor=base, yshift=5pt] {\textcolor{C3}{Excluded}} (window_left);
    \path[draw=C3, ultra thick] (window_right) -- node[above, anchor=base, yshift=5pt] {\textcolor{C3}{Excluded}} (exclude_right);
    \path[draw=C2, ultra thick] (window_left) -- node[above, anchor=base, yshift=5pt] {\textcolor{C2}{Target Interval}} (window_right);

    \node at (-10,-0.5) [align=left, anchor=north west] {
        \begin{tabular}{lll}
            \textcolor{C0}{Background}      & (\SI{990}{\milli\second}) & : Time used for background estimation.                                               \\
            \textcolor{C3}{Excluded}        & (\SI{10}{\milli\second})  & : Exclude this time to prevent contamination of the background by the search region. \\
            \textcolor{C2}{Target Interval} & (Adaptive)                & : Currently selected search area.
        \end{tabular}
    };
