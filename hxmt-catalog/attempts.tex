...
\begin{tikzpicture}
    ...
    \path[draw, ultra thick] (0,0) -- (20,0);
    ...
    \path[draw=C0, <->] ($ (e2) + (0,2.2) $) -- node [fill=white] {\textcolor{C0}{Best}} ($ (e3) + (0,2.2) $);
    \path[draw=C0] (e4) -- ($ (e4) + (0,2.6) $);
    \path[draw=C0, <->] ($ (e2) + (0,2.5) $) -- node [fill=white] {\textcolor{C0}{Full}} ($ (e4) + (0,2.5) $);
    ...
    \begin{scope}[xshift=3.3cm, yshift=-2.3cm]
        ...
        \node at (7.5,0) [right, anchor=base west] {Succeed Attempt};
