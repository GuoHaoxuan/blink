...
\begin{tikzpicture}
    ...
    \node at (-10,-0.5) [align=left, anchor=north west] {
        \begin{tabular}{lll}
            \textcolor{C0}{Background} & (\SI{990}{\micro\second}) & : Time used for background estimation.                                               \\
            \textcolor{C3}{Hollow}     & (\SI{10}{\micro\second})  & : Exclude this time to prevent contamination of the background by the search region. \\
